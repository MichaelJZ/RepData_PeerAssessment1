...
The mean total number of steps taken per day was `r meandailytotalsteps`.

The median total number of steps taken per day was `r mediandailytotalsteps`.
...
The five minute interval with the highest average number of steps is `r intervalwithmaxsteps`.
...
```{r inputingmissingvalues, echo=TRUE}
...
The new mean total number of steps taken per day is `r newmeandailytotalsteps`.

The new median total number of steps taken per day was `r newmediandailytotalsteps`.

The mean remains unchanged while adding the missing values shifted the median.


## Are there differences in activity patterns between weekdays and weekends?
```{r weekdayandweekend, echo=TRUE}
